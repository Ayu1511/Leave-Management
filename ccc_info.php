...
<html>
<head>
	<title>Class Councillor Coordinator Details</title>
...
<body bgcolor=" #ffffe6">
	...
	<div class="w3-bar w3-border w3-signal-red">
	  <a href="ccC_info.php" class="w3-bar-item w3-button w3-green">&nbsp;&nbsp;Home &nbsp;&nbsp;</a>
	  <a href="ccC_modify.php" class="w3-bar-item w3-button w3-hover-teal">&nbsp;&nbsp;Modify Details&nbsp;&nbsp;</a>
	  <a href="ccC_change.php" class="w3-bar-item w3-button w3-hover-teal">&nbsp;&nbsp;Change Password&nbsp;&nbsp;</a>
	  <a href="ccC_logout.php" class="w3-bar-item w3-button w3-green w3-right w3-hover-teal">&nbsp;&nbsp;Logout&nbsp;&nbsp;</a>
	</div>
	...
	<div id="frm" class="w3-card w3-white w3-round-large w3-conatiner" style="width: 550px; margin-top: 50px; margin: 50px auto;">
		...
		<table>
			...
			<tr>
				<td><b>ID:</b></td>
				<td colspan="2" align="right"><?php echo $cccid; ?></td>
			</tr>
			<tr><td>&nbsp;</td></tr>
			<tr>
				<td><b>Class:</b></td>
