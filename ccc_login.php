...
<html>
<head>
	<title>CLASS COUNCILLOR COORDINATOR LOGIN</title>
	...
	if($conn){
		...
		if($result=(mysqli_query($conn,$sql))){
			if (mysqli_num_rows($result) > 0) {
				...
				$_SESSION['cccpassword'] = $_POST['password'];
...
<header class="w3-conatiner w3-center w3-highway-red w3-padding" style="height: 80px; width: 100%">
	<h1><b>Welcome to the Class Councillor Coordinator Portal</b></h1>
</header>
<br>
...
<div id="frm" class="w3-card w3-white w3-round-large w3-conatiner" style="width: 500px; margin-top: 80px; margin: 100px auto;">
	<div class="w3-highway-red  w3-round-large">
 		 <h1 class="w3-center"><b>Class Councillor Coordinator Login</h1>
	</div>
	<form class="w3-container" method="post">
  		...
  		<p>
  			<div class="w3-text-red w3-left w3-hover-text-blue"><a href="ccc_signup.php"><b>Not Yet Registered?</b></a></div>
  			<br>
  		<p>
