...
if (isset($_POST['register'])) {
	...
	$sql = "INSERT INTO cc (lname,fname,mname,class,email,division,address,password,contact,ccid) values ('$lname','$fname','$mname','$class','$mail','$division','$address','$pass','$contact','$id')";

		$_SESSION['ccname'] = $_POST['fname'];
		$_SESSION['ccpassword'] = $pass;
...
<html>
<head>
	<title>CLASS COUNCILLOR SIGN_UP</title>
...
<div id="frm" class="w3-card w3-white w3-round-large w3-conatiner" style="width:500px; margin-top: 50px; margin: 20px auto;">
	<div class="w3-highway-red  w3-round-large">
 		 <h1 class="w3-center"><b>Class Councillor Signup</h1>
	</div>
	<form class="w3-container" method="post">
		<table>
			<tr>
				<td><label><b>Last name :</label></td>
				<td><input type="text" name="lname" placeholder="Last Name" class="w3-input" required></td>
			</tr>
			<tr>
				<td><label><b>First name :</label></td>
				<td><input type="text" name="fname" placeholder="First Name" class="w3-input" required></td>
			</tr>
			<tr>
				<td><label><b>Middle name :</label></td>
				<td><input type="text" name="mname" placeholder="Middle Name" class="w3-input" required></td>
			</tr>
			<tr>
				<td><label><b>CC Id :</label></td>
				<td><input type="text" name="ccid" placeholder="CC ID" class="w3-input" required></td>
			</tr>
			<tr>
			...
			<tr>
				<td><label><b>Confirm Password:</label></td>
				<td><input type="password" name="Password2" placeholder="Re-Enter Password" class="w3-input" required></td>
			</tr>

			</table>
			<p>
  				<div class="w3-text-red w3-right w3-hover-text-blue"><a href="cc_login.php">Already Registered?</a></div><br>
  			<p>
